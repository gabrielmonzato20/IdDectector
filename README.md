...
## Key Features
* This is a Flask porject witch a goal to dectect If a Id from Is rigth or false 
## How To Use


```bash
# Clone this repository
$ git clone https://github.com/gabrielmonzato20/IdDectector.git

# Go into the repository
$ cd carDectection

# Create a virtualenv 
$ python3 -m venv ./IdDectector
# Activate the env
